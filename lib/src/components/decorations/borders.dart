...
/// {@end-tool}
///
/// The image below depicts a [PContinuousRectangleBorder] with a width
...
class PContinuousRectangleBorder extends ShapeBorder {
  ...
  /// to use a [Stack] widget, placing a smaller [PContinuousRectangleBorder] with
  ...
  @override
  ShapeBorder scale(double t) {
    return PContinuousRectangleBorder(
      side: side.scale(t),
  ...
  @override
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is PContinuousRectangleBorder) {
      return PContinuousRectangleBorder(
        side: BorderSide.lerp(a.side, side, t),
  ...
  @override
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is PContinuousRectangleBorder) {
      return PContinuousRectangleBorder(
        side: BorderSide.lerp(side, b.side, t),
  ...
  bool operator ==(Object other) {
    ...
    final PContinuousRectangleBorder typedOther =
        // ignore: test_types_in_equals
        other as PContinuousRectangleBorder;
